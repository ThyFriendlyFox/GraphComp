...
- Feature-sized ideas go to `agent-kit/ROADMAP.md`'s queue via an issue —
  that's the path to getting built.
- New components follow `agent-kit/docs/REGISTRY.md` and meet
  `agent-kit/docs/DESIGN.md`.
